...
public class CreditApplicationsController : BaseController
{
    ...
    public async Task<IActionResult> GetListByCustomer([FromRoute] Guid customerId, [FromQuery] int pageIndex=0, [FromQuery] int pageSize =10)
    {
        var query = new GetListByCustomerCreditApplicationQuery { CustomerId = customerId,PageIndex=pageIndex,PageSize=pageSize };
